# IOE-DREAM 智慧园区管理平台文档中心

> **📚 完整的智慧园区管理平台文档体系**
> **🏗️ 涵盖架构设计、开发指南、API接口、业务流程**
> **🚀 支持微服务架构、容器化部署、AI智能分析**
> **💻 技术架构**: Spring Boot 3.5.8 + Spring Cloud 2025.0.0 + Vue3 + 微服务架构
> **🗄️ 数据库**: MySQL 8.0 + MyBatis-Plus 3.5.15 + Redis

---

## 🎯 文档概览

本文档中心是IOE-DREAM智慧园区管理平台的官方文档库，提供完整的技术文档、API接口文档、业务文档和部署运维文档。
