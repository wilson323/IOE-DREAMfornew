...
import net.lab1024.sa.consume.service.consistency.ConsistencyValidator;
...
public class ConsistencyValidationController {
    ...
    public ResponseDTO<Map<String, Object>> validateAllConsistencyMechanisms() {
        try {
            ...
            if (systemStatus != null) {
                ...
                result.put("hasIssues", systemStatus.hasIssues());
                result.put("message", systemStatus.getMessage());
            }
    ...
    public ResponseDTO<Map<String, Object>> getConsistencyMetrics() {
        try {
            ...
            metrics.put("hasIssues", status != null && status.hasIssues());
