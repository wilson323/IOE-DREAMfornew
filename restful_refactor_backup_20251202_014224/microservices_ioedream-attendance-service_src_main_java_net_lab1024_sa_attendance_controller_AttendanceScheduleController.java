...
public class AttendanceScheduleController {
    ...
    @RequireResource(resource = "attendance:schedule", action = "WRITE", message = "您没有权限创建排班记录")
    ...
    @RequireResource(resource = "attendance:schedule", action = "WRITE", message = "您没有权限更新排班记录")
    public ResponseDTO<Boolean> updateSchedule(@PathVariable Long scheduleId,
            @Valid @RequestBody AttendanceScheduleEntity schedule) {
    ...
    @RequireResource(resource = "attendance:schedule", action = "DELETE", message = "您没有权限删除排班记录")
    ...
    @RequireResource(resource = "attendance:schedule", action = "DELETE", message = "您没有权限批量删除排班记录")
    ...
    @RequireResource(resource = "attendance:schedule", action = "READ", message = "您没有权限查询排班记录")
    ...
    @SaCheckLogin
    @SaCheckPermission("attendance:schedule:query")
    @RequireResource(resource = "attendance:schedule", action = "READ", message = "您没有权限查询员工排班")
    public ResponseDTO<List<AttendanceScheduleEntity>> getEmployeeSchedule(
        ...
        try {
            ...
            // 调用现有Service层查询逻辑
            List<AttendanceScheduleEntity> schedules = attendanceScheduleService.getEmployeeSchedule(employeeId, start,
                    end);
    ...
    @SaCheckLogin
    @SaCheckPermission("attendance:schedule:query")
    @RequireResource(resource = "attendance:schedule", action = "READ", message = "您没有权限查询部门排班")
    public ResponseDTO<List<AttendanceScheduleEntity>> getDepartmentSchedule(
        ...
        try {
            ...
            // 调用现有Service层查询逻辑
            List<AttendanceScheduleEntity> schedules = attendanceScheduleService.getDepartmentSchedule(departmentId,
                    start, end);
    ...
    @SaCheckLogin
    @SaCheckPermission("attendance:schedule:query")
    @RequireResource(resource = "attendance:schedule", action = "READ", message = "您没有权限查询排班状态")
    ...
    @SaCheckLogin
    @SaCheckPermission("attendance:schedule:query")
    @RequireResource(resource = "attendance:schedule", action = "READ", message = "您没有权限查询员工单日排班")
    public ResponseDTO<AttendanceScheduleEntity> getEmployeeScheduleByDate(
        ...
        try {
            ...
            // 调用现有Service层查询逻辑
            AttendanceScheduleEntity schedule = attendanceScheduleService.getEmployeeScheduleByDate(employeeId,
                    scheduleDate);
            if (schedule != null) {
    ...
    @RequireResource(resource = "attendance:schedule", action = "WRITE", message = "您没有权限批量创建排班")
