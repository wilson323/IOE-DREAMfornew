...
public class AccessDeviceController extends SupportBaseController {
    ...
    @RequireResource(resource = "access:device", action = "READ", dataScope = "AREA", message = "您没有权限查询门禁设备列表")
    @PostMapping("/page")
    public ResponseDTO<PageResult<AccessDeviceEntity>> getDevicePage(@Valid @RequestBody PageParam pageParam,
        ...
        log.info(
                "分页查询门禁设备，deviceId: {}, areaId: {}, deviceName: {}, accessDeviceType: {}, onlineStatus: {}, enabled: {}",
                deviceId, areaId, deviceName, accessDeviceType, onlineStatus, enabled);

        try {
            PageResult<AccessDeviceEntity> result = accessDeviceService.getDevicePage(pageParam, deviceId, areaId,
                    deviceName, accessDeviceType, onlineStatus, enabled);
    ...
    public ResponseDTO<AccessDeviceEntity> getDeviceById(
            @Parameter(description = "设备ID", required = true) @PathVariable Long accessDeviceId) {
    ...
    public ResponseDTO<List<AccessDeviceEntity>> getDevicesByAreaId(
    ...
    public ResponseDTO<String> addDevice(@Valid @RequestBody AccessDeviceForm deviceForm) {
        ...
        try {
            ...
            SmartBeanUtil.copyProperties(deviceForm, device);
    ...
    public ResponseDTO<String> batchDeleteDevices(
            @Parameter(description = "设备ID列表", required = true) @RequestBody List<Long> accessDeviceIds) {
    ...
    public ResponseDTO<String> updateDeviceOnlineStatus(
            @Parameter(description = "设备ID", required = true) @PathVariable Long accessDeviceId,
    ...
    public ResponseDTO<String> batchUpdateDeviceOnlineStatus(
            @Parameter(description = "设备ID列表", required = true) @RequestBody List<Long> accessDeviceIds,
    ...
    @RequireResource(resource = "access:device", action = "WRITE", dataScope = "AREA", message = "您没有权限远程控制门禁设备")
    ...
    public ResponseDTO<String> restartDevice(
            @Parameter(description = "设备ID", required = true) @PathVariable Long accessDeviceId) {
        ...
        try {
            ...
            return ResponseDTO.error("重启设备失败: " + e.getMessage());
        }
    }
    ...
    public ResponseDTO<Map<String, Object>> getDeviceHealthStatus(
            @Parameter(description = "设备ID", required = true) @PathVariable Long accessDeviceId) {
    ...
    public ResponseDTO<String> syncDeviceTime(
            @Parameter(description = "设备ID", required = true) @PathVariable Long accessDeviceId) {
        ...
        try {
            ...
            return ResponseDTO.error("同步设备时间失败: " + e.getMessage());
        }
    }
    ...
    public ResponseDTO<String> updateDeviceWorkMode(
            @Parameter(description = "设备ID", required = true) @PathVariable Long accessDeviceId,
