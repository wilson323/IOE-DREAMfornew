...
8. ✅ **ConsumeReportManager** (manager包) - 5处违规
...
13. ✅ **ShiftsManager** - 2处违规
14. ✅ **AttendanceScheduleManager** - 2处违规
...
继续修复剩余的12个Manager文件，确保所有违规项都被修复。

---

**更新时间**: 2025-12-02
**修复状态**: 进行中（14/21文件已完成，52/72违规已修复）
