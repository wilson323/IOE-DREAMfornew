...
-->
<template>
  <a-modal :open="visible" @update:open="val => emit('update:visible', val)" :width="900" title="选择人员" @cancel="closeModal" @ok="onSelectEmployee">
    <a-form class="smart-query-form">
      <a-row class="smart-query-form-row">
        <a-form-item label="关键字" class="smart-query-form-item">
          <a-input style="width: 150px" :value="params.keyword" @update:value="val => emit('update:value', val)" placeholder="关键字" />
        </a-form-item>
        <a-form-item label="部门" class="smart-query-form-item">
          <DepartmentTreeSelect style="width: 200px" ref="departmentTreeSelect" :value="params.departmentId" @update:value="val => emit('update:value', val)" />
        </a-form-item>
        <a-form-item label="状态" class="smart-query-form-item">
          <a-select style="width: 120px" :value="params.disabledFlag" @update:value="val => emit('update:value', val)" placeholder="请选择状态" allowClear>
