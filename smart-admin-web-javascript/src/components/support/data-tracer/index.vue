...
<template>
  <a-form class="smart-query-form">
    <a-row class="smart-query-form-row">
      <a-form-item label="关键字" class="smart-query-form-item">
        <a-input style="width: 300px" :value="queryForm.keywords" @update:value="val => emit('update:value', val)" placeholder="变更内容" />
      </a-form-item>
  ...
  <a-card size="small" :bordered="false">
    ...
    />
    <a-modal :open="visibleDiff" @update:open="val => emit('update:visible', val)" width="90%" title="数据比对" :footer="null">
