...
> **版本**: v1.1.0 - 边缘识别+中心计算模式  
> **微服务**: ioedream-attendance-service (8091)  
> **创建日期**: 2025-12-17  
> **设备交互模式**: 边缘识别+中心计算模式（Mode 3）
...
本文档是IOE-DREAM智慧考勤管理微服务的总体设计文档，基于**边缘识别+中心计算模式**设计，确保考勤微服务下每个子模块的完整性、系统性和一致性。
...
考勤系统采用**边缘识别+中心计算模式**，设备端完成生物识别，服务器端完成排班匹配和考勤统计。
...
erDiagram
    ...
    t_attendance_shift ||--o{ t_attendance_schedule : "班次"
    t_attendance_schedule ||--o{ t_attendance_daily_result : "排班"
    t_attendance_clock_record ||--o{ t_attendance_daily_result : "打卡"
```
