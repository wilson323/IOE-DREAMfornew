...
| **Manager类Spring注解违规** | 20个 | 0个 | 0% | ❌ 未处理 |
| **@Autowired违规** | 16个 | 0个 | 0% | ❌ 未处理 |
| **@Repository违规** | 11个 | 0个 | 0% | ❌ 未处理 |
| **Service接口ResponseDTO违规** | 100+个 | 0个 | 0% | ❌ 未处理 |
| **javax包名违规** | 若干 | 0个 | 0% | ❌ 需检查 |
| **四层架构边界违规** | 若干 | 0个 | 0% | ❌ 需检查 |
