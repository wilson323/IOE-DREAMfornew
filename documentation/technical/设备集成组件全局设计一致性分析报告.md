...
classDiagram
    ...
    ProtocolAdapterFactory --> ProtocolAdapter : 创建
    ProtocolAdapterFactory --> AccessEntropyV48Adapter : 管理
    ProtocolAdapter <|.. AccessEntropyV48Adapter : 实现
```
