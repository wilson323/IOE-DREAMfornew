...
erDiagram
    ...
    t_attendance_schedule_plan ||--o{ t_attendance_personal_schedule : "包含"
    t_attendance_personal_schedule }o--|| t_attendance_record : "关联"
    t_attendance_rule_config }o--o{ t_attendance_record : "规则执行"
```
