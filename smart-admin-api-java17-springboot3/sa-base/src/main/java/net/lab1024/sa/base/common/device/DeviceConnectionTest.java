...
public class DeviceConnectionTest {
     ...
     * @return 失败的连接测试结果
     */
    public static DeviceConnectionTest failure(String errorMessage, String errorDetail, String protocol, String connectionAddress) {
        Map<String, Object> details = new HashMap<>();
        details.put("protocol", protocol);
        details.put("connectionAddress", connectionAddress);
     ...
     * @return 认证失败的连接测试结果
     */
    public static DeviceConnectionTest authenticationFailed(String authType, String protocol, String connectionAddress) {
        Map<String, Object> details = new HashMap<>();
        details.put("protocol", protocol);
        details.put("connectionAddress", connectionAddress);
