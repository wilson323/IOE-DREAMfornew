...
public class SystemEnvironmentConfig implements Condition {
    ...
    public SystemEnvironment initEnvironment() {
        ...
        // DOCKER环境也视为生产环境
        boolean isProd = currentEnvironment == SystemEnvironmentEnum.PROD || currentEnvironment == SystemEnvironmentEnum.DOCKER;
        return new SystemEnvironment(isProd, projectName, currentEnvironment);
    }
}
