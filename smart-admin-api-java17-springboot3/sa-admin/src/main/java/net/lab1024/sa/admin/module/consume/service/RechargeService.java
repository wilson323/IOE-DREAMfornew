...
import net.lab1024.sa.admin.module.consume.manager.RechargeManager;
...
public class RechargeService {
    ...
    public ResponseDTO<Page<RechargeRecordEntity>> queryRechargeRecords(RechargeQueryDTO queryDTO) {
        try {
            ...
            // 使用DAO的queryPage方法
            net.lab1024.sa.base.common.domain.PageResult<RechargeRecordEntity> pageResult = rechargeRecordDao
