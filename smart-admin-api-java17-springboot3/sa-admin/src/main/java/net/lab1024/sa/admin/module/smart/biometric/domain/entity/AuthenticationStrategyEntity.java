...
@TableName("t_authentication_strategies")
public class AuthenticationStrategyEntity extends BaseEntity {
    ...
    public int getSecurityLevelValue() {
        switch (SecurityLevel.fromValue(this.securityLevel)) {
            case LOW:
                return 1;
            case MEDIUM:
                return 2;
    ...
    public Integer getMaxRetryCount() {
        // 解析strategyConfig中的maxRetryCount字段
        return 3; // 简化返回，实际需要详细解析
    }
    ...
    public Integer getTimeoutSeconds() {
        // 解析strategyConfig中的timeoutSeconds字段
        return 30; // 简化返回，实际需要详细解析
    }
}