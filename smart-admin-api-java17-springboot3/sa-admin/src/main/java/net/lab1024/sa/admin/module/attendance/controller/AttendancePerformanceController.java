...
import net.lab1024.sa.admin.module.attendance.service.AttendancePerformanceTestService;
import net.lab1024.sa.admin.module.attendance.service.AttendancePerformanceMonitorService;
...
public class AttendancePerformanceController {
    ...
    public ResponseDTO<Map<String, Object>> validateOptimizationEffects() {
        try {
            ...
            // 计算改进效果
            Map<String, Object> validationResult = calculateOptimizationValidation(beforeOptimization, currentPerformance);
    ...
    public ResponseDTO<Map<String, Object>> getOptimizationRecommendations() {
        try {
            ...
            recommendations.put("optimizationRecommendations", performanceAnalyzer.generateOptimizationRecommendations());
    ...
    private boolean checkIndexHealth() {
        try {
            ...
            java.util.List<Map<String, Object>> duplicateIndexes =
                (java.util.List<Map<String, Object>>) indexStats.get("duplicateIndexes");
     ...
     * 计算优化验证结果
     */
    private Map<String, Object> calculateOptimizationValidation(Map<String, Object> before, Map<String, Object> current) {
                ...
                if (beforeQueries != null && currentBenchmark != null) {
                    ...
                    for (String queryType : queryTypes) {
                        ...
                        if (currentTime != null && beforeQueries.containsKey(queryType.replace("Query", ""))) {
                            @SuppressWarnings("unchecked")
                            Map<String, Object> beforeQuery = (Map<String, Object>) beforeQueries.get(queryType.replace("Query", ""));
                            if (beforeQuery != null) {
