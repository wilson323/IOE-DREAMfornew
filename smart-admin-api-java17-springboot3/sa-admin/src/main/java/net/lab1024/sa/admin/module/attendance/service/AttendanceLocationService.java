...
import net.lab1024.sa.admin.module.attendance.manager.AttendanceRuleManager;
...
public class AttendanceLocationService {
    ...
    public LocationValidationResult validateLocation(Long employeeId, Double latitude, Double longitude) {
        try {
            ...
            // 2. 通过Manager层获取员工适用的考勤规则，符合四层架构
            List<AttendanceRuleEntity> applicableRules = attendanceRuleManager.selectApplicableRules(employeeId,
