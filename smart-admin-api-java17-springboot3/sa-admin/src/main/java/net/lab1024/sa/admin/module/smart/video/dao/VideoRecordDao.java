 ...
 */
@Mapper
public interface VideoRecordDao extends BaseMapper<VideoRecordEntity> {
     ...
     * @return 分页结果
     */
    PageResult<VideoRecordEntity> selectPage(PageParam pageParam, VideoRecordEntity condition);
     ...
     * @return 录像记录列表
     */
    List<VideoRecordEntity> selectByDeviceId(@Param("deviceId") Long deviceId, @Param("limit") Integer limit);
     ...
     * @return 录像记录列表
     */
    List<VideoRecordEntity> selectByRecordStatus(@Param("recordStatus") String recordStatus, @Param("limit") Integer limit);
     ...
     * @return 录像记录列表
     */
    List<VideoRecordEntity> selectByTimeRange(@Param("startTime") LocalDateTime startTime,
     ...
     * @return 录像记录列表
     */
    List<VideoRecordEntity> selectLargeFiles(@Param("minFileSize") Long minFileSize, @Param("limit") Integer limit);
