...
public class ConsumeController extends SupportBaseController {
    ...
    @RequireResource(code = "consume:pay", scope = "SELF")
    ...
    @RequireResource(code = "smart:consume:record", scope = "DEPT")
    ...
    public ResponseDTO<List<Map<String, Object>>> batchConsume(@Valid @RequestBody List<Map<String, Object>> consumeRequests) {
        try {
    ...
    public ResponseDTO<String> exportRecords(
        ...
        try {
            return ResponseDTO.ok(consumeService.exportRecords(personId, orderNo, deviceId, consumeMode, status, startTime, endTime, format));
        } catch (Exception e) {
