...
import net.lab1024.sa.admin.module.attendance.domain.entity.TimePeriodsEntity;
import net.lab1024.sa.admin.module.attendance.domain.query.TimePeriodsQuery;
