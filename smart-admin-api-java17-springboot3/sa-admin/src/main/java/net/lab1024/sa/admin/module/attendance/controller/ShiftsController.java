...
public class ShiftsController {
    ...
    @RequireResource(code = "attendance:shifts", action = "WRITE", scope = "AREA")
    ...
    @RequireResource(code = "attendance:shifts", action = "DELETE", scope = "AREA")
    ...
    @RequireResource(code = "attendance:shifts", action = "READ", scope = "AREA")
