...
public interface VideoDeviceManagerInterface {
     ...
     *
     * @param deviceId 设备ID
     * @param faceFeatures 人脸特征数据列表
     * @param timestamp 识别时间戳
     * @throws Exception 业务异常
     */
    void processFaceRecognitionResult(Long deviceId, List<Map<String, Object>> faceFeatures, java.time.LocalDateTime timestamp) throws Exception;
