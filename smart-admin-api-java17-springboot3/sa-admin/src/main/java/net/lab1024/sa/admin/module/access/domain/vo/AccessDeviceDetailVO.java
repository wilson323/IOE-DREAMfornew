...
public class AccessDeviceDetailVO {
     ...
     * 门禁设备扩展配置
     */
    @Schema(description = "门禁设备扩展配置")
    private SmartDeviceAccessExtensionEntity extension;

    /**
     * 关联的门列表
     */
    @Schema(description = "关联的门列表")
    private List<SmartAccessDoorEntity> doors;

    /**
     * 关联的读卡器列表
     */
    @Schema(description = "关联的读卡器列表")
    private List<SmartAccessReaderEntity> readers;

    /**
     * 最新告警列表
     */
    @Schema(description = "最新告警列表")
    private List<SmartAccessAlertEntity> latestAlerts;
