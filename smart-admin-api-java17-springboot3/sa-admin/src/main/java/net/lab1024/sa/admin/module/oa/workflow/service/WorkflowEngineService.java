package net.lab1024.sa.admin.module.oa.workflow.service;
...
public interface WorkflowEngineService {
     ...
     * @return 部署结果
     */
    ResponseDTO<String> deployProcess(String bpmnXml, String processName,
     ...
     * @return 分页结果
     */
    ResponseDTO<PageResult<WorkflowDefinitionEntity>> pageDefinitions(PageParam pageParam,
     ...
     * @return 实例ID
     */
    ResponseDTO<Long> startProcess(Long definitionId, String businessKey,
     ...
     * @param status 状态(可选)
     * @param startUserId 发起人ID(可选)
     * @param startDate 开始日期(可选)
     * @param endDate 结束日期(可选)
     * @return 分页结果
     */
    ResponseDTO<PageResult<WorkflowInstanceEntity>> pageInstances(PageParam pageParam,
