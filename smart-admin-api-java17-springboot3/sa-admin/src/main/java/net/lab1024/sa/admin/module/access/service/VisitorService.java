...
public interface VisitorService {
     ...
     * @return 预约列表
     */
    ResponseDTO<PageResult<VisitorReservationEntity>> getReservationPage(
            net.lab1024.sa.base.common.domain.PageParam pageParam,
            String keyword,
     ...
     * @return 操作结果
     */
    ResponseDTO<String> approveReservation(Long reservationId, Integer approvalStatus,
     ...
     * @return 访问记录列表
     */
    ResponseDTO<PageResult<VisitorRecordEntity>> getAccessRecordPage(
            net.lab1024.sa.base.common.domain.PageParam pageParam,
            String keyword,
            Long visitAreaId,
