...
public class BiometricRecordEntity extends BaseEntity {
    ...
    /**
     * 验证元数据（JSON格式） { "algorithm": "FaceNet-v2", "algorithmVersion": "2.1.0", "modelVersion":
     * "v20241201", "threshold": 0.85, "similarityScore": 0.92, "distance": 0.08, "qualityScore":
     * 0.88 }
     */
    ...
    /**
     * 活体检测详情（JSON格式） { "blink": true, "headTurn": true, "mouthMovement": false, "livenessScore":
    ...
    /**
     * 异常详情（JSON格式） { "type": "PHOTO_ATTACK", "confidence": 0.92, "description": "检测到照片攻击",
    ...
    /**
     * 地理位置信息（JSON格式） { "latitude": 39.9042, "longitude": 116.4074, "accuracy": 10.0, "address":
     * "北京市朝阳区" }
     */
    ...
    public enum VerificationResult {
        SUCCESS("success", "成功"), FAILURE("failure", "失败"), TIMEOUT("timeout",
                "超时"), LIVENESS_FAILED("liveness_failed", "活体检测失败"), ERROR("error", "系统错误");
