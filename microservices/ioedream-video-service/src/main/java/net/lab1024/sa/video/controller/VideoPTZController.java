...
public class VideoPTZController {
    ...
    @Operation(summary = "云台上移", description = "控制云台向上移动")
    ...
    public CompletableFuture<ResponseDTO<Void>> ptzUp(
            @Parameter(description = "设备ID", required = true, example = "1001") @PathVariable Long deviceId,
            @Parameter(description = "移动速度(1-10)", example = "5") @RequestParam(defaultValue = "5") @Min(1) @Max(10) Integer speed) {
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "云台下移", description = "控制云台向下移动")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "云台左移", description = "控制云台向左移动")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "云台右移", description = "控制云台向右移动")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "云台停止移动", description = "停止云台当前移动")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "放大变焦", description = "控制镜头放大变焦")
    @PostMapping("/{deviceId}/zoom-in")
    @PermissionCheck(value = { "VIDEO_USE", "VIDEO_MANAGE" }, description = "PTZ操作权限")
    public CompletableFuture<ResponseDTO<Void>> zoomIn(
            @Parameter(description = "设备ID", required = true, example = "1001") @PathVariable Long deviceId,
            @Parameter(description = "变焦速度(1-10)", example = "5") @RequestParam(defaultValue = "5") @Min(1) @Max(10) Integer speed) {
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "缩小变焦", description = "控制镜头缩小变焦")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "停止变焦", description = "停止当前变焦操作")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "设置预设位", description = "将当前位置设置为预设位")
    ...
    public CompletableFuture<ResponseDTO<Void>> setPreset(
            @Parameter(description = "设备ID", required = true, example = "1001") @PathVariable Long deviceId,
            @Parameter(description = "预设位编号(1-255)", required = true, example = "1") @RequestParam @Min(1) @Max(255) Integer presetId,
            @Parameter(description = "预设位名称", example = "入口位置") @RequestParam(required = false) String presetName) {
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "调用预设位", description = "移动云台到指定预设位")
    @PostMapping("/{deviceId}/preset/{presetId}/call")
    @PermissionCheck(value = { "VIDEO_USE", "VIDEO_MANAGE" }, description = "PTZ操作权限")
    public CompletableFuture<ResponseDTO<Void>> callPreset(
            @Parameter(description = "设备ID", required = true, example = "1001") @PathVariable Long deviceId,
            @Parameter(description = "预设位编号", required = true, example = "1") @PathVariable Integer presetId,
            @Parameter(description = "移动速度(1-10)", example = "5") @RequestParam(defaultValue = "5") @Min(1) @Max(10) Integer speed) {
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "删除预设位", description = "删除指定的预设位")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "获取预设位列表", description = "查询设备所有预设位信息")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "开始巡航", description = "开始按预设位巡航")
    @PostMapping("/{deviceId}/patrol/start")
    @PermissionCheck(value = { "VIDEO_USE", "VIDEO_MANAGE" }, description = "PTZ操作权限")
    public CompletableFuture<ResponseDTO<Void>> startPatrol(
            @Parameter(description = "设备ID", required = true, example = "1001") @PathVariable Long deviceId,
            @Parameter(description = "预设位列表，用逗号分隔", example = "1,2,3") @RequestParam(required = false) String presetIds,
            @Parameter(description = "巡航速度(1-10)", example = "5") @RequestParam(defaultValue = "5") @Min(1) @Max(10) Integer speed,
            @Parameter(description = "停留时间(秒)", example = "10") @RequestParam(defaultValue = "10") @Min(1) @Max(60) Integer dwellTime) {
        log.info("[PTZ控制] 开始巡航, deviceId={}, presetIds={}, speed={}, dwellTime={}", deviceId, presetIds, speed,
                dwellTime);
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "停止巡航", description = "停止当前巡航")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "暂停巡航", description = "暂停当前巡航，可以恢复")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "恢复巡航", description = "恢复暂停的巡航")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "获取PTZ状态", description = "查询设备PTZ功能当前状态")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "获取当前位置", description = "查询云台当前的位置坐标")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "重置PTZ", description = "重置PTZ到初始状态")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "自动校准", description = "自动校准PTZ位置")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "3D定位控制", description = "通过点击画面控制云台定位到指定位置")
    @PostMapping("/{deviceId}/3d-position")
    @PermissionCheck(value = { "VIDEO_USE", "VIDEO_MANAGE" }, description = "PTZ操作权限")
    public CompletableFuture<ResponseDTO<Void>> setPosition3D(
            @Parameter(description = "设备ID", required = true, example = "1001") @PathVariable Long deviceId,
            @Parameter(description = "X坐标", required = true, example = "100") @RequestParam @NotNull Integer x,
            @Parameter(description = "Y坐标", required = true, example = "100") @RequestParam @NotNull Integer y,
            @Parameter(description = "缩放级别", example = "1") @RequestParam(defaultValue = "1") @Min(1) @Max(10) Integer zoom) {
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "获取PTZ能力", description = "查询设备支持的PTZ功能")
     ...
     */
    @TimeLimiter(name = "videoPTZController")
    @Operation(summary = "批量PTZ控制", description = "同时控制多个设备的PTZ")
    @PostMapping("/batch-control")
    @PermissionCheck(value = "VIDEO_MANAGE", description = "PTZ管理操作")
    public CompletableFuture<ResponseDTO<Map<Long, Object>>> batchPTZControl(
            @Parameter(description = "设备ID列表", required = true) @RequestParam String deviceIds,
            @Parameter(description = "控制命令", required = true, example = "up") @RequestParam String command,
            @Parameter(description = "控制参数", example = "speed=5") @RequestParam(required = false) Map<String, Object> params) {
