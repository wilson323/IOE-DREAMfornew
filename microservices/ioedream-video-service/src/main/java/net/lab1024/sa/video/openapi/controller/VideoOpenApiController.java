...
import net.lab1024.sa.video.openapi.domain.request.AIAnalysisQueryRequest;
import net.lab1024.sa.video.openapi.domain.request.BehaviorAnalysisRequest;
import net.lab1024.sa.video.openapi.domain.request.DownloadRequest;
import net.lab1024.sa.video.openapi.domain.request.FaceDetectionRequest;
import net.lab1024.sa.video.openapi.domain.request.ObjectTrackingRequest;
import net.lab1024.sa.video.openapi.domain.request.PTZControlRequest;
import net.lab1024.sa.video.openapi.domain.request.RecordingQueryRequest;
import net.lab1024.sa.video.openapi.domain.request.StartStreamRequest;
import net.lab1024.sa.video.openapi.domain.request.StopStreamRequest;
import net.lab1024.sa.video.openapi.domain.request.VideoDeviceQueryRequest;
import net.lab1024.sa.video.openapi.domain.response.AIAnalysisResultResponse;
import net.lab1024.sa.video.openapi.domain.response.AIAnalysisStatisticsResponse;
import net.lab1024.sa.video.openapi.domain.response.BehaviorAnalysisResponse;
import net.lab1024.sa.video.openapi.domain.response.DownloadTaskResponse;
import net.lab1024.sa.video.openapi.domain.response.FaceDetectionResponse;
import net.lab1024.sa.video.openapi.domain.response.LiveStreamResponse;
import net.lab1024.sa.video.openapi.domain.response.ObjectTrackingResponse;
import net.lab1024.sa.video.openapi.domain.response.PlaybackResponse;
import net.lab1024.sa.video.openapi.domain.response.StreamControlResponse;
import net.lab1024.sa.video.openapi.domain.response.VideoDeviceDetailResponse;
import net.lab1024.sa.video.openapi.domain.response.VideoDeviceResponse;
import net.lab1024.sa.video.openapi.domain.response.VideoDeviceStatusResponse;
import net.lab1024.sa.video.openapi.domain.response.VideoRecordingResponse;
import net.lab1024.sa.video.openapi.domain.response.VideoStatisticsResponse;
...
public class VideoOpenApiController {
        ...
        @Resource
        private VideoOpenApiService videoOpenApiService;
        ...
        public ResponseDTO<LiveStreamResponse> getLiveStream(
                ...
                LiveStreamResponse response = videoOpenApiService.getLiveStream(deviceId, streamType, protocol, quality,
                                token);
        ...
        public ResponseDTO<StreamControlResponse> startLiveStream(
                ...
                StreamControlResponse response = videoOpenApiService.startLiveStream(deviceId, request, token,
                                clientIp);
                return ResponseDTO.ok(response);
        }
        ...
        public ResponseDTO<PlaybackResponse> getPlaybackUrl(
                ...
                PlaybackResponse response = videoOpenApiService.getPlaybackUrl(recordingId, protocol,
                                startDateTime != null ? startDateTime.toString() : null,
                                endDateTime != null ? endDateTime.toString() : null, token);
                return ResponseDTO.ok(response);
        }
        ...
        public ResponseDTO<DownloadTaskResponse> downloadRecording(
                ...
                DownloadTaskResponse response = videoOpenApiService.downloadRecording(recordingId, request, token,
                                clientIp);
                return ResponseDTO.ok(response);
        }
        ...
        public ResponseDTO<PageResult<AIAnalysisResultResponse>> getAIAnalysisResults(
                ...
                PageResult<AIAnalysisResultResponse> result = videoOpenApiService.getAIAnalysisResults(queryRequest,
                                token);
                return ResponseDTO.ok(result);
        }
        ...
        public ResponseDTO<PageResult<VideoDeviceResponse>> getVideoDevices(
                ...
                VideoDeviceQueryRequest queryRequest = VideoDeviceQueryRequest.builder()
                                ...
                                .status(deviceStatus != null ? deviceStatus.toString() : null)
