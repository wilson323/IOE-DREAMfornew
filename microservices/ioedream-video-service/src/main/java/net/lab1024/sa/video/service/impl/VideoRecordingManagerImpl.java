...
import net.lab1024.sa.video.service.VideoRecordingManager;
...
public class VideoRecordingManagerImpl implements VideoRecordingManager {
    ...
    public String createScheduleRecord(Long deviceId, String scheduleName,
        ...
        try {
            ...
            // 缓存计划信息
            cacheService.set("video:schedule:" + scheduleId, scheduleInfo, 86400L, TimeUnit.SECONDS);
    ...
    public boolean setStorageStrategy(Map<String, Object> strategy) {
        try {
            ...
            // 缓存存储策略
            cacheService.set("video:storage:strategy", strategy, 86400L, TimeUnit.SECONDS);
