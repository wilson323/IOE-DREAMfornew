...
public class VideoRecordingController {
    ...
    public ResponseDTO<VideoRecordingDetailVO> getRecordingDetail(
        ...
        return videoRecordingService.getRecordingDetail(recordingId);
    }
    ...
    public ResponseDTO<VideoRecordingPlaybackVO> getRecordingPlaybackUrl(
        ...
        return videoRecordingService.getRecordingPlaybackUrl(recordingId);
    }
    ...
    public ResponseDTO<Void> deleteRecording(
        ...
        return videoRecordingService.deleteRecording(recordingId);
    }
    ...
    public ResponseDTO<Void> batchDeleteRecordings(@RequestBody List<Long> recordingIds) {
        ...
        return videoRecordingService.batchDeleteRecordings(recordingIds);
    }
    ...
    public ResponseDTO<Map<String, Object>> getRecordingStatistics(
        ...
        return videoRecordingService.getRecordingStatistics(deviceId);
    }
    ...
    public ResponseDTO<Map<String, Object>> checkRecordingIntegrity(
        ...
        return videoRecordingService.checkRecordingIntegrity(recordingId);
    }
    ...
    public ResponseDTO<Map<String, Object>> repairRecording(
        ...
        return videoRecordingService.repairRecording(recordingId);
    }
    ...
    public ResponseDTO<PageResult<VideoRecordingVO>> getDeviceRecordings(
        ...
        return videoRecordingService.getDeviceRecordings(deviceId, pageNum, pageSize);
    }
    ...
    public ResponseDTO<PageResult<VideoRecordingVO>> getEventRecordings(
        ...
        return videoRecordingService.getEventRecordings(eventType, pageNum, pageSize);
    }
    ...
    public ResponseDTO<Map<String, Object>> getTranscodeTaskStatus(
        ...
        return videoRecordingService.getTranscodeTaskStatus(taskId);
    }
    ...
    public ResponseDTO<Void> cancelTranscodeTask(
        ...
        return videoRecordingService.cancelTranscodeTask(taskId);
    }
    ...
    public ResponseDTO<Map<String, Object>> backupRecordings(
            @Parameter(description = "录像ID列表", required = true) @RequestBody List<Long> recordingIds,
            @Parameter(description = "备份类型", required = true) @RequestParam String backupType) {
        log.info("[录像回放] 收到备份录像请求: recordingIds={}, backupType={}", recordingIds, backupType);
        return videoRecordingService.backupRecordings(recordingIds, backupType);
    }
    ...
    public ResponseDTO<Map<String, Object>> getBackupTaskStatus(
        ...
        return videoRecordingService.getBackupTaskStatus(taskId);
    }
    ...
    public ResponseDTO<Map<String, Object>> getStorageUsage(
        ...
        return videoRecordingService.getStorageUsage(deviceId);
    }
}
