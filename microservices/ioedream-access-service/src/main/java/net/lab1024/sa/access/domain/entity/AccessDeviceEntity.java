...
import net.lab1024.sa.common.device.entity.SmartDeviceEntity;
...
public class AccessDeviceEntity extends SmartDeviceEntity {
     ...
     * 获取门禁设备类型（兼容方法）
     */
    public Integer getAccessDeviceType() {
        return this.accessDeviceType;
    }

    /**
     * 设置门禁设备类型（兼容方法）
     */
    public void setAccessDeviceType(Integer accessDeviceType) {
