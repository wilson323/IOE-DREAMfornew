...
public class BiometricTemplateEntity extends BaseEntity {
    ...
    @NotBlank
    @Size(max = 100)
    @Schema(description = "模板名称", example = "用户正面人脸识别模板")
    ...
    @Schema(description = "特征向量", example = "AI算法提取的特征向量")
    ...
    @Schema(description = "最后使用时间", example = "2025-01-30T09:15:00")
    private LocalDateTime lastUseTime;

    @Schema(description = "图像存储路径", example = "/biometric/face/1001_20250130.jpg")
