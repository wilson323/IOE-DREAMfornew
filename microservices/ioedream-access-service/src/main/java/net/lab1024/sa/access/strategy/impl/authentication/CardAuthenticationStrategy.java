...
public class CardAuthenticationStrategy extends AbstractAuthenticationStrategy {
    ...
    protected VerificationResult doAuthenticate(AccessVerificationRequest request) {
        log.debug("[IC卡认证] 记录认证方式: userId={}, deviceId={}, areaId={}, cardNo={}, verifyType={}",
                request.getUserId(), request.getDeviceId(), request.getAreaId(), request.getCardNo(), request.getVerifyType());
        ...
        return VerificationResult.success("IC卡认证方式记录成功", null, "card");
    }
