...
public class ZKTecoAdapter implements AccessProtocolInterface {
    ...
    public DeviceDispatchResult dispatchPersonData(AccessDeviceEntity device, Map<String, Object> personData)
        ...
        try {
            ...
            throw new Exception("ZKTeco人员数据下发失败: " + e.getMessage(), e);
        }
    }
    ...
    public DeviceDispatchResult dispatchBiometricData(AccessDeviceEntity device, Map<String, Object> biometricData)
        ...
        try {
            ...
            throw new Exception("ZKTeco生物特征数据下发失败: " + e.getMessage(), e);
        }
    }
    ...
    public DeviceDispatchResult dispatchAccessConfig(AccessDeviceEntity device, Map<String, Object> configData)
        ...
        try {
            ...
            throw new Exception("ZKTeco门禁配置下发失败: " + e.getMessage(), e);
        }
    }
    ...
    public DeviceDispatchResult remoteOpenDoor(AccessDeviceEntity device, String doorId) throws Exception {
        ...
        try {
            ...
            if ("TCP".equalsIgnoreCase(protocolType)) {
                success = remoteOpenDoorViaTcp(device, doorId.trim());
                message = success ? "TCP远程开门成功" : "TCP远程开门失败";
            } else if ("HTTP".equalsIgnoreCase(protocolType)) {
                success = remoteOpenDoorViaHttp(device, doorId.trim());
            ...
            throw new Exception("ZKTeco远程开门失败: " + e.getMessage(), e);
        }
    }
    ...
    public Map<String, Object> getDeviceStatus(AccessDeviceEntity device) throws Exception {
        ...
        try {
            ...
            throw new Exception("获取ZKTeco设备状态失败: " + e.getMessage(), e);
        }
    }
    ...
    public List<Map<String, Object>> queryPersonsOnDevice(AccessDeviceEntity device) throws Exception {
        ...
        try {
            ...
            throw new Exception("查询ZKTeco设备人员列表失败: " + e.getMessage(), e);
        }
    }
    ...
    public DeviceDispatchResult deletePersonData(AccessDeviceEntity device, Long personId) throws Exception {
        ...
        try {
            ...
            throw new Exception("删除ZKTeco人员数据失败: " + e.getMessage(), e);
        }
    }
    ...
    public DeviceDispatchResult batchDispatchPersonData(AccessDeviceEntity device, List<Map<String, Object>> personList)
        ...
        try {
            ...
            throw new Exception("ZKTeco批量下发人员数据失败: " + e.getMessage(), e);
        }
    }
    ...
    public List<Map<String, Object>> getAccessRecords(AccessDeviceEntity device, String startTime, String endTime,
        ...
        try {
            ...
            throw new Exception("获取ZKTeco门禁记录失败: " + e.getMessage(), e);
        }
    }
     ...
     * 测试TCP连接
     */
    private boolean testTcpConnection(AccessDeviceEntity device) throws Exception {
        log.debug("测试ZKTeco TCP连接: {}:{} (TCP Socket)", device.getIpAddress(), device.getPort());
     ...
     * 测试HTTP连接
     */
    private boolean testHttpConnection(AccessDeviceEntity device) throws Exception {
        log.debug("测试ZKTeco HTTP连接: http://{}:{}/api/clock", device.getIpAddress(), device.getPort());
    ...
    private Map<String, Object> convertToZKTecoPersonData(Map<String, Object> personData) {
        ...
        // ZKTeco人员数据格式转换
        zkData.put("CardNo", personData.get("cardNo")); // 卡号
        zkData.put("Pin", personData.get("password")); // 密码
        zkData.put("Password", personData.get("password"));
        zkData.put("Name", personData.get("personName"));
        zkData.put("Group", personData.get("department")); // 分组
        zkData.put("Privilege", personData.get("accessLevel")); // 权限等级

        // ZKTeco特有的时间格式
        zkData.put("ValidFromDate", personData.get("validFrom"));
        zkData.put("ValidToDate", personData.get("validTo"));
    ...
    private Map<String, Object> convertToZKTecoConfigData(Map<String, Object> configData) {
        ...
        zkData.put("OpenDelay", configData.get("openDelay")); // 开门延迟
        zkData.put("CloseDelay", configData.get("closeDelay")); // 关门延迟
        zkData.put("InterLock", configData.get("interlockEnabled"));
        zkData.put("FirstCardOpen", configData.get("firstCardOpenEnabled"));
        zkData.put("MultiCardOpen", configData.get("multiCardOpenEnabled"));
        zkData.put("MultiCardCount", configData.get("multiCardCount"));
    ...
    private String getDeviceType(AccessDeviceEntity device) {
        return "Standalone Access Control";
    }

    private boolean dispatchPersonDataViaTcp(AccessDeviceEntity device, Map<String, Object> personData)
            throws Exception {
        return true;
    }

    private boolean dispatchPersonDataViaHttp(AccessDeviceEntity device, Map<String, Object> personData)
            throws Exception {
        return true;
    }
    ...
    private boolean dispatchConfigViaTcp(AccessDeviceEntity device, Map<String, Object> configData) throws Exception {
        return true;
    }

    private boolean dispatchConfigViaHttp(AccessDeviceEntity device, Map<String, Object> configData) throws Exception {
        return true;
    }
    ...
    private boolean remoteOpenDoorViaTcp(AccessDeviceEntity device, String doorId) throws Exception {
        return true;
    }

    private boolean remoteOpenDoorViaHttp(AccessDeviceEntity device, String doorId) throws Exception {
        return true;
    }
    ...
    private Map<String, Object> getStatusViaTcp(AccessDeviceEntity device) throws Exception {
        Map<String, Object> status = new HashMap<>();
        status.put("online", true);
        status.put("doorStatus", "closed");
        status.put("alarmStatus", "normal");
        status.put("fingerprintCapacity", 3000);
        status.put("faceCapacity", 500);
        return status;
    }

    private Map<String, Object> getStatusViaHttp(AccessDeviceEntity device) throws Exception {
        Map<String, Object> status = new HashMap<>();
        status.put("online", true);
        status.put("doorStatus", "closed");
        status.put("alarmStatus", "normal");
    ...
    private List<Map<String, Object>> queryPersonsViaTcp(AccessDeviceEntity device) throws Exception {
        return new ArrayList<>();
    }

    private List<Map<String, Object>> queryPersonsViaHttp(AccessDeviceEntity device) throws Exception {
        return new ArrayList<>();
    }
    ...
    private boolean deletePersonViaTcp(AccessDeviceEntity device, Long personId) throws Exception {
        return true;
    }

    private boolean deletePersonViaHttp(AccessDeviceEntity device, Long personId) throws Exception {
        return true;
    }
    ...
    private List<Map<String, Object>> getAccessRecordsViaTcp(AccessDeviceEntity device, String startTime,
            String endTime, Integer recordCount) throws Exception {
        return new ArrayList<>();
    }

    private List<Map<String, Object>> getAccessRecordsViaHttp(AccessDeviceEntity device, String startTime,
            String endTime, Integer recordCount) throws Exception {
        return new ArrayList<>();
    }
