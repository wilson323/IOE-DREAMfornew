...
public class DahuaAdapter implements AccessProtocolInterface {
    ...
    public DeviceDispatchResult dispatchPersonData(AccessDeviceEntity device, Map<String, Object> personData)
        ...
        try {
            ...
            throw new Exception("大华人员数据下发失败: " + e.getMessage(), e);
        }
    }
    ...
    public DeviceDispatchResult dispatchBiometricData(AccessDeviceEntity device, Map<String, Object> biometricData)
        ...
        try {
            ...
            } else if ("IRIS".equalsIgnoreCase(biometricType)) {
                success = dispatchIrisData(device, biometricData);
                message = success ? "虹膜数据下发成功" : "虹膜数据下发失败";
            } else {
            ...
            throw new Exception("大华生物特征数据下发失败: " + e.getMessage(), e);
        }
    }
    ...
    public DeviceDispatchResult dispatchAccessConfig(AccessDeviceEntity device, Map<String, Object> configData)
        ...
        try {
            ...
            throw new Exception("大华门禁配置下发失败: " + e.getMessage(), e);
        }
    }
    ...
    public DeviceDispatchResult remoteOpenDoor(AccessDeviceEntity device, String doorId) throws Exception {
        ...
        try {
            ...
            throw new Exception("大华远程开门失败: " + e.getMessage(), e);
        }
    }
    ...
    public Map<String, Object> getDeviceStatus(AccessDeviceEntity device) throws Exception {
        ...
        try {
            ...
            throw new Exception("获取大华设备状态失败: " + e.getMessage(), e);
        }
    }
    ...
    public List<Map<String, Object>> queryPersonsOnDevice(AccessDeviceEntity device) throws Exception {
        ...
        try {
            ...
            throw new Exception("查询大华设备人员列表失败: " + e.getMessage(), e);
        }
    }
    ...
    public DeviceDispatchResult deletePersonData(AccessDeviceEntity device, Long personId) throws Exception {
        ...
        try {
            ...
            throw new Exception("删除大华人员数据失败: " + e.getMessage(), e);
        }
    }
    ...
    public DeviceDispatchResult batchDispatchPersonData(AccessDeviceEntity device, List<Map<String, Object>> personList)
        ...
        try {
            ...
            throw new Exception("大华批量下发人员数据失败: " + e.getMessage(), e);
        }
    }
    ...
    public List<Map<String, Object>> getAccessRecords(AccessDeviceEntity device, String startTime, String endTime,
        ...
        try {
            ...
            throw new Exception("获取大华门禁记录失败: " + e.getMessage(), e);
        }
    }
     ...
     * 测试ONVIF连接
     */
    private boolean testOnvifConnection(AccessDeviceEntity device) throws Exception {
    ...
    private Map<String, Object> convertToDahuaPersonData(Map<String, Object> personData) {
        ...
        dhData.put("openDoorTime", personData.get("openMethod"));
    ...
    private Map<String, Object> convertToDahuaConfigData(Map<String, Object> configData) {
        ...
        dhData.put("lockTime", configData.get("closeDelay")); // 锁定时间
        dhData.put("openTime", configData.get("openDelay")); // 开门时间
        ...
        dhData.put("multiCard", configData.get("multiCardOpenEnabled"));
        dhData.put("multiCardCount", configData.get("multiCardCount"));
        dhData.put("normallyOpen", configData.get("normallyOpenEnabled"));
        dhData.put("normallyOpenPeriod", configData.get("normallyOpenPeriod"));
    ...
    private boolean dispatchIrisData(AccessDeviceEntity device, Map<String, Object> biometricData) throws Exception {
        return true;
    }
    ...
    private Map<String, Object> getStatusViaSdk(AccessDeviceEntity device) throws Exception {
        Map<String, Object> status = new HashMap<>();
        status.put("online", true);
        status.put("temperature", "26°C");
        status.put("cpuUsage", "15%");
        status.put("memoryUsage", "48%");
        return status;
    }
