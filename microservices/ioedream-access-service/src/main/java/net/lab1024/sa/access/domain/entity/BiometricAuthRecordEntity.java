...
@Schema(description = "生物识别验证记录实体")
public class BiometricAuthRecordEntity extends BaseEntity {

    @TableId(type = IdType.ASSIGN_ID)
    @Schema(description = "验证ID", example = "BIO_AUTH_20250130_001")
    ...
    @NotNull
    @Schema(description = "验证类型", example = "1", allowableValues = {"1", "2", "3"})
    private Integer authType;

    @NotNull
    @Schema(description = "验证结果", example = "1", allowableValues = {"1", "2", "3"})
    ...
    @Schema(description = "验证时间(毫秒)", example = "1250")
    ...
    @Schema(description = "验证图片路径", example = "/biometric/auth/face_20250130_143000.jpg")
    ...
    @Schema(description = "复核意见", example = "验证正常，通过")
