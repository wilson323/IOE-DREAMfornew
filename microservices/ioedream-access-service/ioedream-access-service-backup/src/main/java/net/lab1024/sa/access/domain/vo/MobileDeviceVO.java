...
public class MobileDeviceVO {
    ...
    @Schema(description = "所属区域名称", example = "A栋一楼大厅")
    private String areaName;

    @Schema(description = "设备位置", example = "A栋一楼大厅主入口")
    ...
    @Schema(description = "电池电量(百分比，仅适用于离线设备)", example = "85")
