...
public class AccessDeviceVO {
    ...
    @Schema(description = "门禁设备类型")
    private Integer accessDeviceType;

    @Schema(description = "门禁设备类型描述")
    private String accessDeviceTypeDesc;
    ...
    @Schema(description = "连续心跳失败次数")
    private Integer heartbeatFailCount;
