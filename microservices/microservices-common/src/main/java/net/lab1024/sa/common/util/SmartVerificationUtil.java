...
public class SmartVerificationUtil {
     ...
     * 车牌号
     */
    public static final String CAR_NUMBER = "([京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼]{1}(([A-HJ-Z]{1}[A-HJ-NP-Z0-9]{5})|([A-HJ-Z]{1}(([DF]{1}[A-HJ-NP-Z0-9]{1}[0-9]{4})|([0-9]{5}[DF]{1})))|"
            + "([A-HJ-Z" + "]{1}[A-D0-9]{1}[0-9]{3}警)))|" +
            "([0-9]{6}使)|((([沪粤川云桂鄂陕蒙藏黑辽渝]{1}A)|鲁B|闽D|蒙E|蒙H)[0-9]{4}领)|(WJ[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼·•]{1}[0-9]{4}[TDSHBXJ0-9]{1})|"
    ...
    public static final String DATE = "(([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9][0-9]{3})-(((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)-(0[1-9]|[12][0-9]|30))"
            ...
            + "([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9"
            + "][0-9]{3})-(((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)-(0[1-9]|[12][0-9]|30))|(02-(0[1-9]|[1][0-9]|2[0-8]))))|("
     ...
     * @param fieldName 字段名称
     */
    public static void notNullAndPositive(Long value, String fieldName) {
     ...
     * @param fieldName 字段名称
     */
    public static void notNullAndPositive(Integer value, String fieldName) {
        if (value == null || value <= 0) {
            throw new IllegalArgumentException(fieldName + " 必须大于0");
        }
    }
     ...
     * @param fieldName 字段名称
     */
    public static void notNull(java.time.LocalDate date, String fieldName) {
        if (date == null) {
            throw new IllegalArgumentException(fieldName + " 不能为空");
        }
    }
     ...
     * @param fieldName 字段名称
     */
    public static void notNull(java.time.LocalDateTime dateTime, String fieldName) {
        if (dateTime == null) {
            throw new IllegalArgumentException(fieldName + " 不能为空");
        }
    }
    ...
    /**
     * 验证表达式是否为真(verify是assertTrue的别名,保持代码一致性)
     *
     * @param expression 表达式
     * @param errorMsg   错误信息
     */
    public static void verify(boolean expression, String errorMsg) {
        assertTrue(expression, errorMsg);
    }
