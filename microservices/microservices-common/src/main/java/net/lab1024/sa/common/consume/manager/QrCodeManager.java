...
import net.lab1024.sa.common.consume.dao.QrCodeDao;
import net.lab1024.sa.common.consume.domain.form.QrCodeGenerateForm;
import net.lab1024.sa.common.consume.domain.form.QrCodeConsumeForm;
import net.lab1024.sa.common.consume.domain.vo.QrCodeVO;
...
public class QrCodeManager {
    ...
    private Map<String, Object> processConsumeLogic(QrCodeEntity qrCode, QrCodeConsumeForm form) {
        try {
            ...
            throw new RuntimeException("消费处理失败: " + e.getMessage(), e);
        }
    }
    ...
    public QrCodeVO convertToVO(QrCodeEntity qrCode) {
        try {
            ...
            throw new RuntimeException("转换VO失败: " + e.getMessage(), e);
        }
    }
