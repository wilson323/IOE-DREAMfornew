 ...
 */
@Data
@Schema(description = "消费商户添加表单")
public class ConsumeMerchantAddForm {
    ...
    @Schema(description = "商户类型", example = "RESTAURANT", allowableValues = {"RESTAURANT", "SUPERMARKET", "CAFETERIA", "SHOP"})
    ...
    @Schema(description = "结算方式", example = "DAILY", allowableValues = {"DAILY", "WEEKLY", "MONTHLY"})
    private String settlementMethod;

    @Schema(description = "费率", example = "0.02")
    private java.math.BigDecimal commissionRate;

    @Schema(description = "商户状态", example = "ACTIVE", allowableValues = {"ACTIVE", "INACTIVE", "SUSPENDED"})
