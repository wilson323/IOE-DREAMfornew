...
public interface ConsumeAccountService {
     ...
     * @return 账户ID
     */
    Long createAccount(net.lab1024.sa.consume.domain.entity.AccountEntity accountEntity);
     ...
     * @return 是否成功
     */
    boolean updateAccount(net.lab1024.sa.consume.domain.entity.AccountEntity accountEntity);
