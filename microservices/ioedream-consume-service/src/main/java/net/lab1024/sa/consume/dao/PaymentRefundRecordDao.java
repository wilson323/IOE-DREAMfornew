...
public interface PaymentRefundRecordDao extends BaseMapper<PaymentRefundRecordEntity> {
        ...
        default IPage<PaymentRefundRecordEntity> selectPageByCondition(Page<PaymentRefundRecordEntity> page,
                ...
                // 注意：PaymentRefundRecordEntity可能没有userId字段，使用applicantId代替
                wrapper.eq(userId != null, PaymentRefundRecordEntity::getApplicantId, userId)
        ...
        default int updateRefundStatusBatch(@Param("refundIds") List<String> refundIds,
                ...
                // 类型转换：List<String>转List<Long>
                List<Long> refundIdLongs = refundIds.stream()
                ...
                if (refundIdLongs.isEmpty()) {
                        return 0;
                }

                LambdaQueryWrapper<PaymentRefundRecordEntity> wrapper = new LambdaQueryWrapper<>();
                wrapper.in(PaymentRefundRecordEntity::getRefundId, refundIdLongs);
        ...
        default int auditRefund(@Param("refundId") String refundId,
                ...
                PaymentRefundRecordEntity updateEntity = new PaymentRefundRecordEntity();
                // 类型转换：String转Long
                Long refundIdLong = refundId != null ? Long.parseLong(refundId) : null;
                updateEntity.setRefundId(refundIdLong);
                ...
                LambdaQueryWrapper<PaymentRefundRecordEntity> wrapper = new LambdaQueryWrapper<>();
                wrapper.eq(PaymentRefundRecordEntity::getRefundId, refundIdLong);
