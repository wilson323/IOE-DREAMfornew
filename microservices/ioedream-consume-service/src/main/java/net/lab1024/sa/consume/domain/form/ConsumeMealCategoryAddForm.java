...
@Schema(description = "消费餐次分类添加表单")
public class ConsumeMealCategoryAddForm {
    ...
    public BigDecimal getMaxAmountLimit() {
        ...
        return BigDecimal.valueOf(100.00); // 默认最大限额100元
    }
    ...
    public BigDecimal getDiscountRate() {
        return BigDecimal.valueOf(0.95); // 默认95折
    }
    ...
    public Integer getSortWeight() {
        return this.sortOrder != null ? this.sortOrder : 1;
    }
