...
public class GatewayFallbackController {
    ...
    public ResponseEntity<Map<String, Object>> commonServiceFallback() {
        ...
        return createFallbackResponse("COMMON_SERVICE_UNAVAILABLE",
                "公共服务暂时不可用，请稍后重试",
                "建议稍后重试或联系管理员");
    }
    ...
    public ResponseEntity<Map<String, Object>> deviceServiceFallback() {
        ...
        return createFallbackResponse("DEVICE_SERVICE_UNAVAILABLE",
                "设备通讯服务暂时不可用",
                "设备可能离线或网络异常，请检查设备状态",
                fallbackData);
    }
    ...
    public ResponseEntity<Map<String, Object>> oaServiceFallback() {
        ...
        return createFallbackResponse("OA_SERVICE_UNAVAILABLE",
                "OA服务暂时不可用",
                "系统正在维护中，部分功能受限",
                fallbackData);
    }
    ...
    public ResponseEntity<Map<String, Object>> accessServiceFallback() {
        ...
        return createFallbackResponse("ACCESS_SERVICE_DEGRADED",
                "门禁服务降级运行",
                "系统已切换到本地验证模式，请联络管理员",
                emergencyData);
    }
    ...
    public ResponseEntity<Map<String, Object>> attendanceServiceFallback() {
        ...
        return createFallbackResponse("ATTENDANCE_SERVICE_UNAVAILABLE",
                "考勤服务暂时不可用",
                "请使用手动考勤记录或稍后重试",
                fallbackData);
    }
    ...
    public ResponseEntity<Map<String, Object>> consumeServiceFallback() {
        ...
        return createFallbackResponse("CONSUME_SERVICE_DEGRADED",
                "消费服务降级运行",
                "系统已切换到离线模式，消费记录将在网络恢复后同步",
                emergencyData);
    }
    ...
    public ResponseEntity<Map<String, Object>> visitorServiceFallback() {
        ...
        return createFallbackResponse("VISITOR_SERVICE_UNAVAILABLE",
                "访客服务暂时不可用",
                "请在前台进行手动访客登记",
                fallbackData);
    }
    ...
    public ResponseEntity<Map<String, Object>> videoServiceFallback() {
        ...
        return createFallbackResponse("VIDEO_SERVICE_UNAVAILABLE",
                "视频服务暂时不可用",
                "实时监控暂时不可用，仅支持录像回放",
                fallbackData);
    }
    ...
    public ResponseEntity<Map<String, Object>> generalServiceFallback(@PathVariable String serviceName) {
        ...
        return createFallbackResponse("SERVICE_UNAVAILABLE",
                serviceName + "服务暂时不可用",
                "请稍后重试或联系系统管理员");
    }
    ...
    public ResponseEntity<Map<String, Object>> getDegradationOverview() {
        ...
        // 联系信息
        overview.put("contactInfo", Map.of(
                "admin", "admin@ioedream.com",
                "hotline", "400-123-4567",
                "emergency", "138-0000-0000"
        ));
     ...
     * 创建标准降级响应
     */
    private ResponseEntity<Map<String, Object>> createFallbackResponse(String errorCode,
                                                                      String message,
                                                                      String suggestion) {
