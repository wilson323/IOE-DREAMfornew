 ...
 * <p>
 * 网关服务使用WebFlux(Reactive)模式，必须使用Reactive Security配置。 此配置类替代传统的Servlet Security配置。
 * </p>
 * <p>
 * <b>功能特性</b>:
 * <ul>
...
public class WebFluxSecurityConfig {
     ...
     * </p>
     * <p>
     * <b>Bean冲突处理</b>: - 使用@ConditionalOnMissingBean避免与microservices-common中的PasswordEncoder冲突 -
     ...
     * </p>
     */
    private static final String[] STATIC_WHITE_LIST = { "/actuator/**", "/doc.html", "/swagger-ui/**",
            "/v3/api-docs/**", "/swagger-resources/**", "/webjars/**", "/favicon.ico", "/api/v1/auth/**", "/login/**",
            "/public/**", "/static/**", "/gateway/health" };
    ...
    public CorsConfigurationSource corsConfigurationSource (CorsProperties corsProperties) {
        ...
        if (!originPatterns.isEmpty ()) {
            ...
            // ⚠️ 开发环境默认值 - 生产环境必须在配置文件中明确设置允许的源
            configuration.setAllowedOrigins (List.of ("http://localhost:3000", "http://localhost:8080"));
        }

        configuration.setAllowedMethods (nonEmptyOrDefault (safeList (props.getAllowedMethods ()),
        ...
        log.info ("[WebFluxSecurity] 企业级CORS配置完成: allowCredentials={}, maxAge={}", allowCredentials,
                configuration.getMaxAge ());
        log.info ("[WebFluxSecurity] CORS origins={}, originPatterns={}", configuration.getAllowedOrigins (),
                configuration.getAllowedOriginPatterns ());
        log.info ("[WebFluxSecurity] CORS allowedMethods={}, allowedHeaders={}, exposedHeaders={}",
                configuration.getAllowedMethods (), configuration.getAllowedHeaders (),
     ...
     *
     * @param http
     *            ServerHttpSecurity配置
     * @return SecurityWebFilterChain (Reactive过滤链)
     */
    @Bean
    public SecurityWebFilterChain securityWebFilterChain (ServerHttpSecurity http,
            WhitelistProperties whitelistProperties, CorsConfigurationSource corsConfigurationSource) {
