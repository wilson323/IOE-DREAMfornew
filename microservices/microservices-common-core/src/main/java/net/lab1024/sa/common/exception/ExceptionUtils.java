...
public final class ExceptionUtils {
    ...
    static {
        ...
        ERROR_MESSAGE_CACHE.put("VALIDATION_ERROR", VALIDATION_ERROR_MESSAGE);
        ...
        ERROR_MESSAGE_CACHE.put("INSUFFICIENT_BALANCE", "账户余额不足");
        ...
        ERROR_MESSAGE_CACHE.put("NETWORK_ERROR", "网络请求超时，请稍后重试");
        ERROR_MESSAGE_CACHE.put("EXTERNAL_SERVICE_ERROR", "外部服务调用失败");
        ERROR_MESSAGE_CACHE.put("FILE_SYSTEM_ERROR", "文件系统错误");
        ERROR_MESSAGE_CACHE.put("MEMORY_ERROR", "内存不足");
    }
