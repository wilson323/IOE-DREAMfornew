...
public class FlowableDmnRuleService {
     ...
     * @return 决策结果列表
     */
    public List<Map<String, Object>> executeDecisionByKeyMultipleResults(String decisionKey, Map<String, Object> variables) {
     ...
     * @return 决策执行审计容器
     */
    public DecisionExecutionAuditContainer executeDecisionWithAuditTrail(String decisionKey, Map<String, Object> variables) {
