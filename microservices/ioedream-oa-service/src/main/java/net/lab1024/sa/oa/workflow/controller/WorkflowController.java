...
import net.lab1024.sa.oa.workflow.domain.entity.WorkflowDefinitionEntity;
import net.lab1024.sa.oa.workflow.domain.entity.WorkflowInstanceEntity;
import net.lab1024.sa.oa.workflow.domain.entity.WorkflowTaskEntity;
...
public class WorkflowController {
    ...
    public ResponseDTO<PageResult<net.lab1024.sa.oa.workflow.domain.entity.WorkflowDefinitionEntity>> pageDefinitions(
    ...
    public ResponseDTO<net.lab1024.sa.oa.workflow.domain.entity.WorkflowDefinitionEntity> getDefinition(
    ...
    public ResponseDTO<PageResult<net.lab1024.sa.oa.workflow.domain.entity.WorkflowInstanceEntity>> pageInstances(@Valid PageParam pageParam,
    ...
    public ResponseDTO<net.lab1024.sa.oa.workflow.domain.entity.WorkflowInstanceEntity> getInstance(@PathVariable @NotNull Long instanceId) {
    ...
    public ResponseDTO<PageResult<net.lab1024.sa.oa.workflow.domain.entity.WorkflowTaskEntity>> pageMyTasks(@Valid PageParam pageParam,
    ...
    public ResponseDTO<PageResult<net.lab1024.sa.oa.workflow.domain.entity.WorkflowTaskEntity>> pageMyCompletedTasks(
    ...
    public ResponseDTO<PageResult<net.lab1024.sa.oa.workflow.domain.entity.WorkflowInstanceEntity>> pageMyProcesses(
            @Valid PageParam pageParam, @RequestParam @NotNull Long userId,
            @RequestParam(required = false) String category,
            @RequestParam(required = false) String status) {
    ...
    public ResponseDTO<net.lab1024.sa.oa.workflow.domain.entity.WorkflowTaskEntity> getTask(@PathVariable @NotNull Long taskId) {
