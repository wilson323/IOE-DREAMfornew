...
public class CaseManagementService {
    ...
    public String deployCaseDefinition (String caseDefinitionXml, String caseDefinitionKey, String caseDefinitionName) {
        ...
        var deployment = cmmnRepositoryService.createDeployment ().name (caseDefinitionName).key (caseDefinitionKey)
                .addString (caseDefinitionKey + ".cmmn", caseDefinitionXml).deploy ();
    ...
    public String startCaseInstance (String caseDefinitionKey, String caseName, String businessKey,
        ...
        CaseInstance caseInstance = cmmnRuntimeService.createCaseInstanceBuilder ()
                .caseDefinitionId (caseDefinition.getId ()).name (caseName).businessKey (businessKey)
    ...
    public List<Task> getCaseTasks (String caseInstanceId) {
        return cmmnTaskService.createTaskQuery ().caseInstanceId (caseInstanceId).orderByTaskCreateTime ().desc ()
                .list ();
    }
    ...
    public List<CaseDefinition> getCaseDefinitions () {
        return cmmnRepositoryService.createCaseDefinitionQuery ().latestVersion ().orderByCaseDefinitionName ().asc ()
                .list ();
    }
