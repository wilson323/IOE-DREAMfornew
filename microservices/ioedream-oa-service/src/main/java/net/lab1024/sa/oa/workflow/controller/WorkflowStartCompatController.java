 ...
 * 工作流启动兼容入口
 * <p>
 * 兼容 microservices-common 中 WorkflowApprovalManager 现有的调用路径：POST
 * /api/v1/workflow/start 内部转调 OA 工作流引擎的标准入口。
 * </p>
 */
@RestController
...
public class WorkflowStartCompatController {
     ...
     * 启动流程实例（兼容接口）
     * <p>
     * 期望请求体结构与 WorkflowApprovalManager 构建的参数一致： - definitionId - businessKey -
     * instanceName - variables - formData
     * </p>
     */
