...
public class FlowableRepositoryService {
    ...
    public String deployProcessDefinition(String resourceName, InputStream inputStream) {
        ...
        try {
            ...
            log.error("[Flowable] 流程部署失败: resourceName={}, error={}",
    ...
    public String deployProcessDefinitionText(String resourceName, String resourceText) {
        ...
        try {
            Deployment deployment = repositoryService.createDeployment()
                    .addString(resourceName, resourceText)
                    .deploy();
    ...
    public ProcessDefinition getProcessDefinition(String processDefinitionKey, boolean latestVersion) {
        ...
        try {
            ...
            log.error("[Flowable] 获取流程定义失败: processDefinitionKey={}, error={}",
    ...
    public ProcessDefinition getProcessDefinitionById(String processDefinitionId) {
        ...
        try {
            ...
            log.error("[Flowable] 获取流程定义失败: processDefinitionId={}, error={}",
     ...
     * @return 流程定义列表
     */
    public List<ProcessDefinition> getProcessDefinitionsPage(int pageNum, int pageSize,
                                                          String key, String name) {
        log.debug("[Flowable] 分页查询流程定义: pageNum={}, pageSize={}, key={}, name={}",
                pageNum, pageSize, key, name);
        ...
        try {
            ...
            return query.orderByProcessDefinitionName()
                    .asc()
    ...
    public void suspendProcessDefinition(String processDefinitionId) {
        ...
        try {
            ...
            log.error("[Flowable] 挂起流程定义失败: processDefinitionId={}, error={}",
                    processDefinitionId, e.getMessage(), e);
    ...
    public void activateProcessDefinition(String processDefinitionId) {
        ...
        try {
            ...
            log.error("[Flowable] 激活流程定义失败: processDefinitionId={}, error={}",
                    processDefinitionId, e.getMessage(), e);
    ...
    public void deleteDeployment(String deploymentId, boolean cascade) {
        ...
        try {
            ...
            log.error("[Flowable] 删除流程部署失败: deploymentId={}, error={}",
    ...
    public String getBpmnModel(String processDefinitionId) {
        ...
        try {
            ...
            log.error("[Flowable] 获取BPMN模型失败: processDefinitionId={}, error={}",
                    processDefinitionId, e.getMessage(), e);
            return null;
        }
    }
    ...
    public InputStream getProcessDiagram(String processDefinitionId) {
        ...
        try {
            ...
            log.error("[Flowable] 获取流程图失败: processDefinitionId={}, error={}",
                    processDefinitionId, e.getMessage(), e);
            return null;
        }
    }
