...
public class ApprovalFeatureService {
    ...
    public void withdrawToPreviousNode (String taskId, String userId, String reason) {
        ...
        runtimeService.createChangeActivityStateBuilder ().processInstanceId (currentTask.getProcessInstanceId ())
                .moveActivityIdTo (currentTask.getTaskDefinitionKey (), "startEvent").changeState ();
    ...
    private void saveApprovalRecord (String processInstanceId, String taskId, String userId, boolean approved,
            String comment) {
