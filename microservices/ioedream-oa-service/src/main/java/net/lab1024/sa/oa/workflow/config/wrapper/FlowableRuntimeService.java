 ...
 * Flowable流程运行时服务包装器
 * <p>
 * 提供流程实例管理的完整功能封装 包括流程启动、执行、查询、统计等功能
 * </p>
 *
...
public class FlowableRuntimeService {
    ...
    public String startProcessInstanceByKey (String processDefinitionKey, String businessKey,
            Map<String, Object> variables, String starterUserId) {
        log.info ("[Flowable] 启动流程实例: processDefinitionKey={}, businessKey={}, starterUserId={}", processDefinitionKey,
                businessKey, starterUserId);
        ...
        try {
            ...
            log.info ("[Flowable] 流程实例启动成功: processInstanceId={}, processDefinitionId={}", processInstance.getId (),
                    processInstance.getProcessDefinitionId ());

            return processInstance.getId ();

        } catch (Exception e) {
            log.error ("[Flowable] 启动流程实例失败: processDefinitionKey={}, businessKey={}, error={}", processDefinitionKey,
     ...
     * @return 流程实例对象
     */
    public ProcessInstance startProcessInstanceByKeyWithFullResult (String processDefinitionKey, String businessKey,
            Map<String, Object> variables, String starterUserId) {
        log.info ("[Flowable] 启动流程实例: processDefinitionKey={}, businessKey={}, starterUserId={}", processDefinitionKey,
                businessKey, starterUserId);
     ...
     * @return 流程实例ID
     */
    public String startProcessInstanceById (String processDefinitionId, String businessKey,
            Map<String, Object> variables, String starterUserId) {
        log.info ("[Flowable] 启动流程实例: processDefinitionId={}, businessKey={}, starterUserId={}", processDefinitionId,
                businessKey, starterUserId);
        ...
        try {
            ...
            log.error ("[Flowable] 启动流程实例失败: processDefinitionId={}, businessKey={}, error={}", processDefinitionId,
                    businessKey, e.getMessage (), e);
            throw new RuntimeException ("启动流程实例失败: " + e.getMessage (), e);
        }
    }
    ...
    public ProcessInstance getProcessInstance (String processInstanceId) {
        ...
        try {
            ...
            log.error ("[Flowable] 获取流程实例失败: processInstanceId={}, error={}", processInstanceId, e.getMessage (), e);
            return null;
        }
    }
    ...
    public List<ProcessInstance> getRunningProcessInstances () {
        ...
        try {
            return runtimeService.createProcessInstanceQuery ().active ().orderByStartTime ().desc ().list ();
     ...
     * @return 流程实例列表
     */
    public List<ProcessInstance> getProcessInstancesPage (int pageNum, int pageSize, String processDefinitionKey,
            String businessKey, String starterUserId) {
        log.debug (
                "[Flowable] 分页查询流程实例: pageNum={}, pageSize={}, processDefinitionKey={}, businessKey={}, starterUserId={}",
        ...
        try {
            ...
            return query.orderByStartTime ().desc ().listPage (pageNum * pageSize, pageSize);
    ...
    public void deleteProcessInstance (String processInstanceId, String deleteReason) {
        log.info ("[Flowable] 删除流程实例: processInstanceId={}, deleteReason={}", processInstanceId, deleteReason);
        ...
        try {
            ...
            log.error ("[Flowable] 删除流程实例失败: processInstanceId={}, error={}", processInstanceId, e.getMessage (), e);
    ...
    public void suspendProcessInstance (String processInstanceId) {
        ...
        try {
            ...
            log.error ("[Flowable] 挂起流程实例失败: processInstanceId={}, error={}", processInstanceId, e.getMessage (), e);
    ...
    public void activateProcessInstance (String processInstanceId) {
        ...
        try {
            ...
            log.error ("[Flowable] 激活流程实例失败: processInstanceId={}, error={}", processInstanceId, e.getMessage (), e);
    ...
    public void signalEventReceived (String signalName, Map<String, Object> variables) {
        ...
        try {
            ...
            log.error ("[Flowable] 发送信号失败: signalName={}, error={}", signalName, e.getMessage (), e);
    ...
    public void signalEventReceived (String signalName, String processInstanceId, Map<String, Object> variables) {
        log.info ("[Flowable] 发送信号给流程实例: signalName={}, processInstanceId={}", signalName, processInstanceId);

        try {
            runtimeService.signalEventReceived (signalName, processInstanceId, variables);
            log.info ("[Flowable] 信号发送成功: signalName={}, processInstanceId={}", signalName, processInstanceId);

        } catch (Exception e) {
            log.error ("[Flowable] 发送信号失败: signalName={}, processInstanceId={}, error={}", signalName,
    ...
    public void setVariables (String processInstanceId, Map<String, Object> variables) {
        log.debug ("[Flowable] 设置流程变量: processInstanceId={}, variables={}", processInstanceId,
        ...
        try {
            ...
            log.error ("[Flowable] 设置流程变量失败: processInstanceId={}, error={}", processInstanceId, e.getMessage (), e);
    ...
    public Map<String, Object> getVariables (String processInstanceId, List<String> variableNames) {
        log.debug ("[Flowable] 获取流程变量: processInstanceId={}, variableNames={}", processInstanceId, variableNames);

        try {
            return runtimeService.getVariables (processInstanceId, variableNames);

        } catch (Exception e) {
            log.error ("[Flowable] 获取流程变量失败: processInstanceId={}, error={}", processInstanceId, e.getMessage (), e);
            return Map.of ();
        }
    }
}
