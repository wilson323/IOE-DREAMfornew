 ...
 * <p>
 * 提供企业级决策管理功能，支持决策表部署、决策执行、 决策版本控制、决策结果缓存等高级功能 兼容Flowable 7.2.0 DMN引擎API
 * </p>
 *
...
public class DecisionEngineService {
    ...
    public String deployDecision (String name, String dmnXml) {
        ...
        DmnDeployment deployment = dmnRepositoryService.createDeployment ().name (name)
                .addInputStream (name + ".dmn", dmnStream).deploy ();
    ...
    public Map<String, Object> executeDecision (String decisionKey, Map<String, Object> variables) {
        ...
        try {
            Map<String, Object> result = dmnDecisionService.createExecuteDecisionBuilder ().decisionKey (decisionKey)
                    .variables (variables).executeWithSingleResult ();
    ...
    public List<Map<String, Object>> executeDecisionMultiple (String decisionKey, Map<String, Object> variables) {
        ...
        try {
            List<Map<String, Object>> results = dmnDecisionService.createExecuteDecisionBuilder ()
                    .decisionKey (decisionKey).variables (variables).execute ();
     ...
     * @return 决策执行审计容器
     */
    public DecisionExecutionAuditContainer executeDecisionWithAudit (String decisionKey,
        ...
        try {
            DecisionExecutionAuditContainer auditContainer = dmnDecisionService.createExecuteDecisionBuilder ()
                    .decisionKey (decisionKey).variables (variables).executeWithAuditTrail ();
    ...
    public List<Map<String, Object>> listDecisions () {
        ...
        DmnDecisionQuery query = dmnRepositoryService.createDecisionQuery ().latestVersion ();
