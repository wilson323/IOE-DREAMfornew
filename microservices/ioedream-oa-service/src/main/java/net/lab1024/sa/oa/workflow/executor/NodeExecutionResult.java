...
public class NodeExecutionResult {
    ...
    public NodeExecutionResult setStatus(ExecutionStatus status) {
        this.status = status;
        return this;
    }

    public NodeExecutionResult setOutputData(Map<String, Object> outputData) {
    ...
    public NodeExecutionResult setStartTime(LocalDateTime startTime) {
        this.startTime = startTime;
        return this;
    }

    public NodeExecutionResult setEndTime(LocalDateTime endTime) {
        this.endTime = endTime;
        return this;
    }

    public NodeExecutionResult setDuration(Long duration) {
        this.duration = duration;
        return this;
    }

    public NodeExecutionResult setNeedRetry(boolean needRetry) {
        this.needRetry = needRetry;
        return this;
    }

    public NodeExecutionResult setRetryCount(int retryCount) {
    ...
    public static NodeExecutionResult success() {
        return new NodeExecutionResult()
                ...
                .setOutputData(new java.util.HashMap<String, Object>())
    ...
    public static NodeExecutionResult success(Map<String, Object> outputData) {
        return new NodeExecutionResult()
                .setStatus(ExecutionStatus.SUCCESS)
                .setOutputData(outputData != null ? outputData : new java.util.HashMap<String, Object>())
                .setStartTime(LocalDateTime.now())
                .setEndTime(LocalDateTime.now());
    }
