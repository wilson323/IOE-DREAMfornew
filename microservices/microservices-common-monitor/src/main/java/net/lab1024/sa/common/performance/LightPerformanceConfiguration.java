...
public class LightPerformanceConfiguration {
     ...
     * 轻量级性能监控器
     * <p>
     * 注意：使用@ConditionalOnMissingBean避免与MonitoringConfiguration中的performanceMonitor冲突
     * </p>
     */
    @Bean(name = "lightPerformanceMonitor")
    public LightPerformanceMonitor lightPerformanceMonitor() {
    ...
    public static class PerformanceMonitorAspect {
        ...
        @jakarta.annotation.Resource(name = "lightPerformanceMonitor")
        private LightPerformanceMonitor lightPerformanceMonitor;
        ...
        public Object monitorPerformance(org.aspectj.lang.ProceedingJoinPoint joinPoint, PerformanceMonitor monitor) throws Throwable {
            ...
            return lightPerformanceMonitor.timeExecution(operation, () -> {
                try {
                    return joinPoint.proceed();
                } catch (Throwable throwable) {
                    log.error("[性能监控] 方法执行异常: operation={}, error={}", operation, throwable.getMessage(), throwable);
                    if (throwable instanceof RuntimeException) {
                        throw (RuntimeException) throwable;
                    } else if (throwable instanceof Error) {
                        throw (Error) throwable;
                    } else {
                        throw new SystemException("PERFORMANCE_MONITOR_EXECUTION_ERROR", "方法执行异常: " + throwable.getMessage(), throwable);
                    }
                }
            });
        }
