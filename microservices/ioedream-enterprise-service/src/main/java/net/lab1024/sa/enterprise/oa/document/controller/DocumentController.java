package net.lab1024.sa.enterprise.oa.document.controller;
...
import net.lab1024.sa.enterprise.oa.document.domain.form.DocumentPermissionUpdateForm;
import net.lab1024.sa.enterprise.oa.document.domain.form.DocumentQueryForm;
import net.lab1024.sa.enterprise.oa.document.domain.form.DocumentSearchForm;
import net.lab1024.sa.enterprise.oa.document.domain.form.DocumentUpdateForm;
import net.lab1024.sa.enterprise.oa.document.domain.form.DocumentVersionCreateForm;
...
public class DocumentController {
    ...
    public ResponseDTO<List<DocumentPermissionVO>> getDocumentPermissions(
        ...
        for (DocumentPermissionEntity e : resp.getData()) {
            ...
            vo.setAccessLevel(e.getAccessLevel() != null ? e.getAccessLevel() : "VIEW");
            list.add(vo);
        }
        return ResponseDTO.ok(list);
    }
