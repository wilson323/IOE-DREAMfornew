 ...
 * 登录控制器（兼容前端legacy路径）
 * <p>
 * 为兼容前端 /login/** 路径，将请求转发到 AuthService 前端 smart-admin-web-javascript 使用 /login/** 路径
 * </p>
 *
...
public class LoginController {
    ...
    /**
     * 获取验证码 兼容前端 /login/getCaptcha 路径
     */
    ...
    public ResponseDTO<Map<String, Object>> getCaptcha () {
        ...
        result.put ("captchaBase64",
                "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg=="); // 占位符
    ...
    /**
     * 获取登录用户信息 兼容前端 GET /login/getLoginInfo 路径
     */
    ...
    public ResponseDTO<UserInfoVO> getLoginInfo (
    ...
    /**
     * 发送邮箱验证码 兼容前端 GET /login/sendEmailCode/{loginName} 路径
     */
    ...
    /**
     * 获取双因子登录标识 兼容前端 GET /login/getTwoFactorLoginFlag 路径
     */
