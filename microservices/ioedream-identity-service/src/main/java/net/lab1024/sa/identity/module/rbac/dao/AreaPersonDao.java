...
import net.lab1024.sa.identity.module.rbac.domain.entity.AreaPersonEntity;
...
public interface AreaPersonDao extends BaseMapper<AreaPersonEntity> {
     ...
     * @return 更新数量
     */
    int batchUpdateStatusByAreaIds(@Param("areaIds") List<Long> areaIds, @Param("operatorId") Long operatorId, @Param("status") Integer status);
