...
INSERT INTO t_common_dict_type (dict_type_name, dict_type_code, description, sort_order) VALUES
...
-- 用户性别
INSERT INTO t_common_dict_data (dict_type_code, dict_label, dict_value, dict_sort, css_class, list_class) VALUES
...
-- 系统管理模块权限
INSERT INTO t_common_permission (permission_name, permission_code, resource_type, parent_id, sort_order, icon, component) VALUES
...
INSERT INTO t_common_area (area_name, area_code, area_type, parent_id, level, sort_order, capacity, status) VALUES
...
INSERT INTO t_system_config (config_key, config_value, config_name, description, config_type) VALUES
...
INSERT INTO t_common_device (device_no, device_name, device_type, device_model, manufacturer, area_id, ip_address, port, status) VALUES
...
INSERT INTO t_video_device (device_no, device_name, device_type, area_id, ip_address, port, username, password, rtsp_url, status) VALUES
...
INSERT INTO t_attendance_shift (shift_name, work_start_time, work_end_time, break_start_time, break_end_time, work_days, status) VALUES
...
INSERT INTO t_consume_account (user_id, account_no, account_name, balance, status) VALUES
