...
public interface ExceptionApplicationsDao extends BaseMapper<ExceptionApplicationsEntity> {
     ...
     * @return 分页结果
     */
    Page<ExceptionApplicationsEntity> selectPageByCondition(Page<ExceptionApplicationsEntity> page,
     ...
     * @return 申请列表
     */
    List<ExceptionApplicationsEntity> selectByEmployeeId(@Param("employeeId") Long employeeId,
