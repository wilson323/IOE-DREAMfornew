...
public class AttendanceDataSyncService {
    ...
    public static class ConsistencyCheckResult {
        ...
        public void setReport(ConsistencyReport report) {
            this.report = report;
        }

        public Map<String, List<ConsistencyIssue>> getIssuesByType() {
            return issuesByType;
        }

        public void setIssuesByType(Map<String, List<ConsistencyIssue>> issuesByType) {
    ...
    public static class ConsistencyReport {
        ...
        public void setAutoFixed(int autoFixed) {
