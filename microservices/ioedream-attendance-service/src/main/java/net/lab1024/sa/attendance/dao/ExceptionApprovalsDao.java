...
import net.lab1024.sa.attendance.domain.entity.ExceptionApprovalsEntity;
...
public interface ExceptionApprovalsDao extends BaseMapper<ExceptionApprovalsEntity> {
     ...
     * @return 审批记录列表
     */
    List<ExceptionApprovalsEntity> selectByApproverId(@Param("approverId") Long approverId,
     ...
     * @return 分页结果
     */
    Page<ExceptionApprovalsEntity> selectPageByCondition(Page<ExceptionApprovalsEntity> page,
            @Param("query") Map<String, Object> queryMap);
