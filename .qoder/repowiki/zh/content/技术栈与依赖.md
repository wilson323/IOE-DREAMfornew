...
- 版本与统一管理
  - 父 POM 统一管理 Java 17、Spring Boot 3.5.8、Spring Cloud 2025.0.0、Spring Cloud Alibaba 2025.0.0.0、MyBatis-Plus 3.5.15、Sa-Token 1.44.0、Druid 等版本，确保各模块一致性。
...
- 认证与授权
  ...
  - OpenApiConfig 中明确列出 Spring Boot 3.5.8、Spring Cloud 2025.0.0、Spring Cloud Alibaba 2025.0.0.0、Sa-Token + JWT、MyBatis-Plus、Redis、MySQL 等技术栈。
- 配置与安全
...
- 配置中心与服务治理
  ...
  - Spring Cloud Alibaba 2025.0.0.0 支持完整的 `optional:nacos:` 功能，允许配置中心可选加载，解决了 `dataId must be specified` 错误。
- 监控与告警
...
## 依赖关系分析
- 后端依赖管理
  - 父 POM 通过 Spring Boot、Spring Cloud、Spring Cloud Alibaba 三大 BOM 管理版本，避免依赖冲突；统一 Java 17、Spring Boot 3.5.8、Spring Cloud 2025.0.0、Spring Cloud Alibaba 2025.0.0.0、MyBatis-Plus 3.5.15、Sa-Token 1.44.0、Druid 等版本。
