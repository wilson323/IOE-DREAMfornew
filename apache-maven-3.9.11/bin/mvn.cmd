...
@REM Skip jvm.config due to UTF-8 encoding issues on Windows
...
@REM MNG-8248 - DISABLED due to compatibility issues
@REM "%JAVACMD%" --enable-native-access=ALL-UNNAMED -version >nul 2>&1
@REM if ERRORLEVEL 1 goto skipEnableNativeAccess
@REM set "MAVEN_OPTS=--enable-native-access=ALL-UNNAMED %MAVEN_OPTS%"
@REM :skipEnableNativeAccess
