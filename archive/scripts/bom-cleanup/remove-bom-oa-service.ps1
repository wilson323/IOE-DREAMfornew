...
Write-Host "开始移除OA服务Java文件中的BOM字符..." -ForegroundColor Green

# 获取所有包含BOM的Java文件
$bomFiles = @()
Get-ChildItem -Path "microservices\ioedream-oa-service" -Filter "*.java" -Recurse | ForEach-Object {
...
Write-Host "OA服务BOM字符移除完成！" -ForegroundColor Green
